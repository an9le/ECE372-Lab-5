...
void frown() {
  write(0x01, 0b00000001);      // Row 1 LEDS
  write(0x02, 0b00000010);      // Row 2 LEDS
  write(0x03, 0b01100100);      // Row 3 LEDS
  write(0x04, 0b00000100);      // Row 4 LEDS
  write(0x05, 0b00000100);      // Row 5 LEDS
  write(0x06, 0b01100100);      // Row 6 LEDS
  write(0x07, 0b00000010);      // Row 7 LEDS
  write(0x08, 0b00000001);      // Row 8 LEDS
}



void smile() { 
  write(0x01, 0b00001000);      // Row 1 LEDS
  write(0x02, 0b00000100);      // Row 2 LEDS
  write(0x03, 0b01100010);      // Row 3 LEDS
  write(0x04, 0b00000010);      // Row 4 LEDS
  write(0x05, 0b00000010);      // Row 5 LEDS
  write(0x06, 0b01100010);      // Row 6 LEDS
  write(0x07, 0b00000100);      // Row 7 LEDS
  write(0x08, 0b00001000);      // Row 8 LEDS
}
